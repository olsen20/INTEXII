      ...
      <div className="container py-5 text-start" style={{ marginTop: "80px" }}>
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <p>
              Welcome to CineNiche! These Terms of Service (“Terms”) govern your
              use of our website, applications, and services. By using our
              services, you agree to these Terms. If you do not agree with any
            ...
            <ul>
              <li>
                You must be at least 13 years old (or as required by applicable
                law) to use our services.
              </li>
              <li>
            ...
            <p>
              ...
              content. You are responsible for any content you post and must
              ensure that it does not infringe on the rights of others.
            </p>
            <br />
            <h2 className="fw-bold">4. Intellectual Property</h2>
            <p>
              All content and intellectual property on our services, including
              logos, images, and text, are owned by CineNiche or its licensors.
              You may not use any of our intellectual property without prior
              written consent.
            </p>
            <br />
            ...
            <p>
              ...
              CineNiche is not liable for any indirect, incidental, or
